...
def evaluate_domain_relationship(candidate_domain: str, target_brand: str = "Amazon", official_domain: Optional[str] = None) -> Dict[str, Any]:
    """Helper entry point for classifying domain relationship."""
    return DomainRelationshipEngine.classify_relationship(candidate_domain=candidate_domain, target_brand=target_brand, official_domain=official_domain)
